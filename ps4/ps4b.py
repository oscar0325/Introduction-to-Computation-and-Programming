...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        while i < 26:
            shift_num = (i + shift) % 26
            result[lower_letter[i]] = lower_letter[shift_num]
            result[upper_letter[i]] = upper_letter[shift_num]
            i += 1
        return result
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(0,26):
            word_num = 0
            text_decrypted = PlaintextMessage(text, shift).get_message_text_encrypted()
            ...
            if word_num > word_count:
                word_count = word_num
                shift_best = shift       
        return print((PlaintextMessage(text, shift_best).get_message_text_encrypted(), shift_best))        
